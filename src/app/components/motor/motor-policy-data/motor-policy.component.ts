...
import { IDocumentModel } from 'src/app/Entites/models/common/document-model';
...
import { IPaymentFormDataModel } from 'src/app/Entites/models/motor/payment-form-data-model';
import { PolicyType, SearchPolicyType, Vertical } from 'src/app/shared/utilities/enums/enum';
import { IPolicyTermDto } from '../../../Entites/dtos/motor/policy-term-dto';
...
import { IAddOnRiderModel } from 'src/app/Entites/models/motor/add-on-rider-model';
